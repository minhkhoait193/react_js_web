  ...
  render() {
    ...
    return (
      <div id="content">
        ...
        <div id="product-form">
            <input type="text" placeholder="ID"value={this.state.txtID} onChange={(e) => { this.setState({ txtID: e.target.value }) }} readOnly={true} />
            <input type="text" placeholder="Tên SP"value={this.state.txtName} onChange={(e) => { this.setState({ txtName: e.target.value }) }} />
            <input type="text"placeholder="Giá" value={this.state.txtPrice} onChange={(e) => { this.setState({ txtPrice: e.target.value }) }} />
            ...
            <div class="action-buttons">
              ...
              <input type="submit"class="action-button add-button" value="ADD NEW" onClick={(e) => this.btnAddClick(e)} />
              <input type="submit" class="action-button edit-button"value="UPDATE" onClick={(e) => this.btnUpdateClick(e)} />
              <input type="submit"class="action-button delete-button" value="DELETE" onClick={(e) => this.btnDeleteClick(e)} />
            </div>
